...
impl OptionSet {
    ...
    ///
    /// ```rust
    /// # use pyrogen_workspace::options_base::{OptionField, OptionsMetadata, Visit};
    ///
    /// struct WithOptions;
    ///
    ...
    ///             doc: "Whether Pyrogen should respect the gitignore file",
    ///             default: "false",
    ///             value_type: "bool",
    ///             example: "",
    ///         });
    ...
    ///
    /// ```rust
    /// # use pyrogen_workspace::options_base::{OptionEntry, OptionField, OptionsMetadata, Visit};
    ///
    /// struct WithOptions;
    ///
